...
//        AI ai2 = new LightRush();
        ...
        do{
            if (System.currentTimeMillis()>=nextTimeToUpdate) {
                PlayerAction pa1 = ai1.getAction(0, new PartiallyObservableGameState(gs,0),false);
                PlayerAction pa2 = ai2.getAction(1, new PartiallyObservableGameState(gs,1),false);
                gs.issueSafe(pa1);
                gs.issueSafe(pa2);
