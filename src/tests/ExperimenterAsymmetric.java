...
//                System.out.println("BranchingCalculatorWithTimeOut: timeout!");
    ...
    public static void runExperiments(List<AI> bots1, List<AI> bots2, List<PhysicalGameState> maps, UnitTypeTable utt, int iterations, int max_cycles, int max_inactive_cycles, boolean visualize, PrintStream out,PrintStream out1) throws Exception {
