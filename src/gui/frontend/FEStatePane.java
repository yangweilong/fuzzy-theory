...
public class FEStatePane extends JPanel {
    ...
    public FEStatePane() {
        ...
        //MK
        currentGameState.Realworld = true;
        //
                ...
                b.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e)
                    {
                        ...
                        try {
                            ...
                            ai.reset();
                            PlayerAction a = ai.getAction(0, currentGameState,false);
                        ...
                        Runnable r = new Runnable() {
                             public void run() {
                                try {
                                    ...
                                    //gs.addPlayerAI(0,ai1);
                                    //gs.addPlayerAI(1,ai2);
                                    //MK
                                    gs.addAI(ai1);
                                    gs.addAI(ai2);
                                    ai1.setPlayerID(0);
                                    ...
                                    do{
                                        ...
                                        {
                                            PlayerAction pa1 = ai1.getAction(0, gs,false);
                                            PlayerAction pa2 = ai2.getAction(1, gs,false);                                             
                                            //MK 
    ...
    public AI createAIInternal(int idx, int player) {
        ...
        if (AIs[idx]==PassiveAI.class) {
        	...
        	try {
				return new AHTNAI(a_domainFileName,TIME,MAX_PLAYOUTS,PLAYOUT_TIME,ef,playout_policy);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
        }
        else if(AIs[idx] == EnhanceAHTNAI.class)
        {
        	String a_domainFileName = "E:\\MK\\myProject\\ahtn2\\ahtntest\\ahtn\\microrts-ahtn-definition-low-level-phase.lisp" ;
        	try {
				return new EnhanceAHTNAI(a_domainFileName,TIME,MAX_PLAYOUTS,PLAYOUT_TIME,ef,playout_policy);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
