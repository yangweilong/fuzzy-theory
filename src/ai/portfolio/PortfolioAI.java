...
public class PortfolioAI extends InterruptibleAIWithComputationBudget {
                    ...
                    if (counts[i][j]==0 ||
                        ...
                        while(!gameover && gs2.getTime()<timeLimit) {
                            if (gs2.isComplete()) {
                                ...
                                gs2.issue(ai1.getAction(playerForThisComputation, gs2,false));
                                gs2.issue(ai2.getAction(1-playerForThisComputation, gs2,false));
                            }
                        }                
    ...
    public PlayerAction getBestActionSoFar() throws Exception {
        ...
        ai.reset();
        return ai.getAction(playerForThisComputation, gs_to_start_from,false);
    }
