...
import ai.core.InterruptibleAIWithComputationBudgetWithoutPO;
 ...
 * @author santi
 */
public class UCTwithoutpo extends InterruptibleAIWithComputationBudgetWithoutPO {
    ...
    public UCTwithoutpo(int available_time, int max_playouts, int lookahead, int max_depth, AI policy, EvaluationFunction a_ef) {
    ...
    public void simulate(GameState gs, int time) throws Exception {
        ...
        do{
            if (gs.isComplete()) {
            	...
            	PlayerAction pa =randomAI.getAction(0, gs,false);
                gs.issue(pa);
                gs.issueSafe(pa);
                pa = randomAI.getAction(1, gs,false);
                gs.issue(pa);
                gs.issueSafe(pa);
            }
