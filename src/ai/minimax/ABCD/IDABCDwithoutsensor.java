 ...
 * @author santi
 */
public class IDABCDwithoutsensor extends InterruptibleAIWithComputationBudget {
    ...
    public IDABCDwithoutsensor(int tpc, int ppc, AI a_playoutAI, int a_maxPlayoutTime, EvaluationFunction a_ef, boolean a_performGreedyActionScan) {
        super(tpc, ppc);
    ...
    public AI clone() {
        return new IDABCDwithoutsensor(MAX_TIME, MAX_ITERATIONS, playoutAI, maxPlayoutTime, ef, performGreedyActionScan);
    }
...
//        return bestMove;
    ...
    public PlayerAction getBestActionSoFar() throws Exception {
        ...
        if (bestMove == null) {
            ...
            return pag.getRandomwithoutsensor();
        }
...
//        System.out.println("searchOutsideStack: stack is not empty.");
        if (needAResult) {
            ...
            return head.actions.getRandomwithoutsensor();
        }
        return null;
    }
