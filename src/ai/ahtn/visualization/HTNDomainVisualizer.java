...
public class HTNDomainVisualizer {
 ...
 //       DomainDefinition dd = DomainDefinition.fromLispFile("ahtn/microrts-ahtn-definition-low-level-sensor.lisp");
       DomainDefinition dd = DomainDefinition.fromLispFile("ahtn/microrts-ahtn-definition-low-level.lisp");
       // DomainDefinition dd = DomainDefinition.fromLispFile("ahtn/microrts-ahtn-definition-flexible-portfolio-phase.lisp");
    	//  DomainDefinition dd = DomainDefinition.fromLispFile("ahtn/microrts-ahtn-definition-flexible-portfolio-phase.lisp");
        System.out.println(dd);
        
        HTNDomainVisualizer v = new HTNDomainVisualizer();
        BufferedImage img = v.visualizeHTNDomain(dd, new Symbol("Compound-Task"));
