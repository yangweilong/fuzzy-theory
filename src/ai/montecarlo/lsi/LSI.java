...
public class LSI extends AIWithComputationBudget {
    ...
    public PlayerAction getAction(int player, GameState gameState,boolean partiallyObservable) throws Exception {
        ...
        {
        	 PartiallyObservableGameState POgs1 = new PartiallyObservableGameState(gameState,player);
        	 UpdateGameStateNum(POgs1,gameState);
        	PlayerAction pa2= GetActionbyState(player,POgs1);
        	UpdateGameStateNum(gameState,POgs1);
        	return pa2;
        }
        else
        {
        	return GetActionbyState(player,gameState);
        }
       
    }

    public PlayerAction GetActionbyState(int player,GameState gameState)  throws Exception
    {
    	 // initialize
