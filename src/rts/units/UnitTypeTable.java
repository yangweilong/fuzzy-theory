...
public class UnitTypeTable {
    ...
    public void setUnitTypeTable(int version, int crs) {
        ...
        barracks.canSensor = true;
        barracks.sightRadius = 2;
        barracks.sensorTime = 10;
        barracks.sensoropenTime = 0;
        ...
        worker.canSensor = true;
        worker.sightRadius = 2;
        worker.sensorTime = 10;
        worker.sensoropenTime = 0;
        addUnitType(worker);   
        ...
        ranged.sightRadius = 2;
        ranged.sensorTime = 10;
        ranged.sensoropenTime = 0;
        addUnitType(ranged);     
