...
public class UnitType {
    ...
    public int produceTime = 10, 
               ...
               attackTime = 10, 
               harvestTime = 10,
               sensorTime = 1,//yang感知持续时间
               sensoropenTime =0,//感知器打开时间
               returnTime = 10;
    public int harvestAmount = 1;      // each time the harvest action is executed, how many resources does the unit get

    public int sightRadius = 2; // the radius a unit can see for partially observable game states.
    ...
    public boolean canSensor = true;      // the unit can execute the sensor action
    public boolean canSensor_open = false;
